...
const insertMovies = (movies: Movie[]) => {
 ...
 // var tagL = "";
 // if (movies.tagline === undefined) 
// movies.map(movie => `('${escape(movie.imdbId)}', '${escape(movie.popularity.toString())}', '${escape(movie.budget.toString())}', '${escape(movie.revenue.toString())}', '${escape(movie.originalTitle)}', '${escape(movie.homepage)}', '${escape(movie.tagline)}', '${escape(movie.overview)}', '${escape(movie.runtime.toString())}', '${escape(movie.releaseDate)}', '${escape(movie.budgetAdjusted.toString())}', '${escape(movie.revenueAdjusted.toString())}')`).join(",")
  return (
   `insert into movies (imdb_id, popularity, budget, revenue, original_title, homepage, tagline, overview, runtime, release_date, budget_adj, revenue_adj) values` +
   movies.map(movie => `('${escape(movie.imdbId)}', '${escape(movie.popularity.toString())}', '${escape(movie.budget.toString())}', '${escape(movie.revenue.toString())}', '${escape(movie.originalTitle)}', '${escape(movie.homepage)}', '${movie.tagline === undefined ? "" : escape(movie.tagline)}', '${escape(movie.overview)}', '${escape(movie.runtime.toString())}', '${escape(movie.releaseDate)}', '${escape(movie.budgetAdjusted.toString())}', '${escape(movie.revenueAdjusted.toString())}')`).join(",")
  );
